...
<p align="center"><img src="Screenshots/1.jpg" alt="Низьке F"/></p>

Повільна зміна стану системи
Дисперсія до фільтрації: 16.42
Дисперсія після фільтрації: 3.85
Зменшення шуму: 76.55%

**Високе значення F (F = 10):**
<p align="center"><img src="Screenshots/2.jpg" alt="Високе F"/></p>

Швидка зміна стану системи
Дисперсія до фільтрації: 16.42
Дисперсія після фільтрації: 6.24
Зменшення шуму: 61.99%

**Низьке значення H (H = 0.1):**
<p align="center"><img src="Screenshots/3.jpg" alt="Низьке H"/></p>

Слабкий зв'язок з вимірюваннями
Дисперсія до фільтрації: 16.42
Дисперсія після фільтрації: 5.12
Зменшення шуму: 68.82%

**Високе значення H (H = 10):**
<p align="center"><img src="Screenshots/4.jpg" alt="Високе H"/></p>

Сильний зв'язок з вимірюваннями
Дисперсія до фільтрації: 16.42
Дисперсія після фільтрації: 4.89
Зменшення шуму: 70.22%
...
<p align="center"><img src="Screenshots/5.jpg" alt="Низьке Q"/></p>

Більш плавна фільтрація
Дисперсія до фільтрації: 16.42
Дисперсія після фільтрації: 2.14
Зменшення шуму: 86.97%

**Високе значення Q (Q = 100):**
<p align="center"><img src="Screenshots/6.jpg" alt="Високе Q"/></p>

Швидша реакція на зміни
Дисперсія до фільтрації: 16.42
Дисперсія після фільтрації: 7.82
Зменшення шуму: 52.37%
...
<p align="center"><img src="Screenshots/7.jpg" alt="Низьке R"/></p>

Висока чутливість до нових вимірювань
Дисперсія до фільтрації: 16.42
Дисперсія після фільтрації: 5.67
Зменшення шуму: 65.47%

**Високе значення R (R = 100):**
<p align="center"><img src="Screenshots/8.jpg" alt="Високе R"/></p>

Більша стабільність фільтрації
Дисперсія до фільтрації: 16.42
Дисперсія після фільтрації: 3.45
Зменшення шуму: 78.99%
...
<p align="center"><img src="Screenshots/9.jpg" alt="Низьке P"/></p>

Повільніша початкова збіжність
Дисперсія до фільтрації: 16.42
Дисперсія після фільтрації: 4.12
Зменшення шуму: 74.91%
...
<p align="center"><img src="Screenshots/10.jpg" alt="Висока оцінка"/></p>

Значне початкове відхилення
Дисперсія до фільтрації: 16.42
Дисперсія після фільтрації: 4.56
Зменшення шуму: 72.23%

**Низька початкова оцінка (x = -10):**
<p align="center"><img src="Screenshots/11.jpg" alt="Низька оцінка"/></p>

Поступове наближення до сигналу
Дисперсія до фільтрації: 16.42
Дисперсія після фільтрації: 4.48
Зменшення шуму: 72.72%
...
<p align="center"><img src="Screenshots/12.jpg" alt="Велике зміщення"/></p>

Стабільне відслідковування
Дисперсія до фільтрації: 16.42
Дисперсія після фільтрації: 4.35
Зменшення шуму: 73.51%

**Від'ємне зміщення (offset = -10):**
<p align="center"><img src="Screenshots/13.jpg" alt="Від'ємне зміщення"/></p>

Коректна адаптація до зміщення
Дисперсія до фільтрації: 16.42
Дисперсія після фільтрації: 4.33
Зменшення шуму: 73.63%
...
<p align="center"><img src="Screenshots/14.jpg" alt="Короткий час"/></p>

Базова оцінка роботи
Дисперсія до фільтрації: 16.42
Дисперсія після фільтрації: 4.31
Зменшення шуму: 73.75%

**Довгий час (total_time = 5с):**
<p align="center"><img src="Screenshots/15.jpg" alt="Довгий час"/></p>

Підтвердження стабільності
Дисперсія до фільтрації: 16.42
Дисперсія після фільтрації: 4.29
Зменшення шуму: 73.88%
